...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'kumarsanath364@gmail.com' ")
...
ts = time.time()
date = datetime.datetime.fromtimestamp(ts).strftime('%d%d-%m-%Y')
...
frame1 = tk.Frame(window, bg="#151501")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#151501")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Automated Attendance System Using Face Recognition" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="black",bg="#00aeff" ,font=('times', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="black",bg="#00aeff" ,font=('times', 17, ' bold ') )
head1.place(x=0,y=0)

lbl = tk.Label(frame2, text="Enter ID",width=20  ,height=1  ,fg="white"  ,bg="#151501" ,font=('times', 17, ' bold ') )
lbl.place(x=80, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Name",width=20  ,fg="white"  ,bg="#151501" ,font=('times', 17, ' bold '))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold ')  )
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile" ,bg="#151501" ,fg="white"  ,width=39 ,height=1, activebackground = "yellow" ,font=('times', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="#151501" ,fg="white"  ,width=39,height=1, activebackground = "yellow" ,font=('times', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="Attendance",width=20  ,fg="white"  ,bg="#151501"  ,height=1 ,font=('times', 17, ' bold '))
